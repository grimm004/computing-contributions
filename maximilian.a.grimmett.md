...
All pages passed the W3 HTML validator. The only error generated for each page is a lack of declaration of character encoding however this is not a major issue. The HTML its self is legable, well indented and makes good use of Semantic UI styling.
